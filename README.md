...
After `init_db -load-seed`, populate images with `go run ./cmd/gen_images` or `go run ./cmd/migrate_images`. See [doc/README.jump-server.md](doc/README.jump-server.md).

...
-- Rock throw/unthrow journal entries for conversation timelines
CREATE TABLE rock_events (
    id INTEGER PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    conversation_id INTEGER NOT NULL REFERENCES conversations(id),
    user_id INTEGER NOT NULL REFERENCES users(id),
    kind TEXT NOT NULL CHECK (kind IN ('thrown', 'unthrown')),
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
);
CREATE INDEX idx_rock_events_conversation ON rock_events(conversation_id);
CREATE INDEX idx_rock_events_created_at ON rock_events(created_at);
